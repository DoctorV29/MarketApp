...
<div id="wrap">
  ...
  <div class="post_box">
    <c:forEach items="${allProducts}" var="product">
      ...
      <div class="text"> <h3> <a href="market/item?itemId=${product.id}">${product.name}</a></h3> <br>
        Состав: ${product.composition} <br> </div>
        <br>
        <div class="btn_more float_r">
          <button class="button button2" onclick="document.location='market/item?itemId=${product.id}'">Подробнее</button>
        </div>
        <br>
